document.addEventListener('DOMContentLoaded', () => {
    ...
    function highlightActiveNavLink() {
        const currentPageName = "politica-privacidade";
        allNavLinks.forEach(link => {
            // Verifica o data-page-name e também o href para os links do footer
            const linkPageName = link.dataset.pageName;
            const linkHref = link.getAttribute('href');
            
            if (linkPageName === currentPageName || (linkHref && linkHref.includes(currentPageName + ".html"))) {
    ...
    // Não há JS específico para esta página além do comum.
});

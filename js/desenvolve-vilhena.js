document.addEventListener('DOMContentLoaded', () => {
    ...
    function highlightActiveNavLink() {
        const currentPageName = "desenvolve-vilhena";
    ...
    // --- Lógica Específica da Página Desenvolve Vilhena ---
    const economicCtx = document.getElementById('economicOpportunitiesChart');
    if (economicCtx && typeof Chart !== 'undefined') {
        ...
        new Chart(economicCtx, {
            type: 'bar',
            data: {
                labels: ['Vagas Publicadas', 'CVs Cadastrados', 'Empresas no Guia', 'Freelancers Ativos', 'Selos Emitidos'],
                datasets: [{
                    label: 'Atividade na Plataforma (Simulado)',
                    data: [210, 480, 950, 320, 75], // Dados de exemplo
                    backgroundColor: chartColors[2], // Usando uma cor diferente para este gráfico

document.addEventListener('DOMContentLoaded', () => {
    ...
    function highlightActiveNavLink() {
        const pagesToActivate = ["explore-vilhena", "memorias-vivas"];
    ...
    // --- LÓGICA ESPECÍFICA DA PÁGINA MEMÓRIAS VIVAS ---
    ...
    if (closeAudioModalBtn) {
        closeAudioModalBtn.addEventListener('click', () => closeModal(audioPlayerModal));
    }
